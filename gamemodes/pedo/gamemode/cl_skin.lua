-----------------------------------------------------------
-- Almost the same as fretta, I wanted the menus to feel --
-- like they are from pbe1.                              --
-----------------------------------------------------------
...
SKIN.text_dark					= Color( 160, 160, 160, 255 )
...
function SKIN:PaintTeamScoreboardHeader( panel )
	draw.RoundedBox( 4, 0, 0, panel:GetWide(), panel:GetTall()*2, team.GetColor( panel.iTeamID ) )
end
